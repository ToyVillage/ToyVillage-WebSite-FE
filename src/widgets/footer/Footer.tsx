...
export default function Footer() {
  return (
    <footer className="w-full bg-main-forest-green text-white/90 py-[35] px-[60]">
      <div className="max-w-[1200] mt-[5] ">
        ...
        <div className="flex justify-between md:flex-row items-end gap-6">
          
          <div className="flex flex-wrap gap-x-4 gap-y-1">
            <span className="text-body-3 text-main-light-green">상호 : 주식회사 토이빌리지</span>
            <span className="text-body-3 text-main-light-green hidden md:inline">|</span>
          ...
          <div className="text-right">
            <p className="text-body-3 text-main-light-green">TEL : 053-964-0099</p>
